#ifndef _DOLPHIN_GX_INTERNAL_H
#define _DOLPHIN_GX_INTERNAL_H
...
#define __OLD_SET_REG_FIELD(reg, size, shift, val)                                                                     \
    do {                                                                                                               \
...
#else
#define SET_REG_FIELD(reg, size, shift, val) __SET_REG_FIELD(reg, size, shift, val)
#endif
...
typedef struct __GXData_struct {
    ...
    /* 0x000 0x000 */ u16 vNumNot;
    /* 0x002 0x002 */ u16 bpSentNot;
    /* 0x004 0x004 */ u16 vNum;
    /* 0x006 0x006 */ u16 vLim;
    ...
    /* 0x200 0x200 */ u8 cpTexZ;

    // General raster mode
    /* 0x204 0x204 */ u32 genMode;

    // Texture regions
    /* 0x208 0x208 */ GXTexRegion TexRegions0[8];
#if IS_MQ
    /* 0x288  N/A  */ GXTexRegion TexRegionsCI[4];
    /* 0x2C8  N/A  */ u32 nextTexRgn;
    /* 0x2CC  N/A  */ u32 nextTexRgnCI;
#else
    /*  N/A  0x288 */ GXTexRegion TexRegions1[8];
    /*  N/A  0x308 */ GXTexRegion TexRegions2[8];
#endif

    // Texture lookup table regions
    /* 0x2D0 0x388 */ GXTlutRegion TlutRegions[20];
    /* 0x410 0x4C8 */ GXTexRegion* (*texRegionCallback)(GXTexObj*, GXTexMapID);
    /* 0x414 0x4CC */ GXTlutRegion* (*tlutRegionCallback)(u32);
    ...
    // Flags
    /* 0x4F0 0x5A8 */ u8 inDispList;
    /* 0x4F1 0x5A9 */ u8 dlSaveContext;
#if IS_CE || IS_MM
    /*  N/A  0x5AA */ u8 abtWaitPECopy;
#endif
