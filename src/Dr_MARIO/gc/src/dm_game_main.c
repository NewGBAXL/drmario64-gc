...
void dm_draw_capsel_by_cpu_tentative(struct_game_state_data* gameStateDataRef, s32 arg1[2], s32 arg2[2]) {
    ...
    for (var_s1 = 0; var_s1 < 2; var_s1++) {
        ...
        //todo: fix
        fb = 0;//&gFramebuffers[gCurrentFramebufferIndex ^ 1][arg2[var_s1] * SCREEN_WIDTH + arg1[var_s1]];
...
s32 dm_game_main_cnt_1P(struct_game_state_data* gameStateData, GameMapCell* mapCells, s32 arg2) {
    ...
    case GAMESTATEDATA_UNK_00C_B:
        ...
        if ((watchGameP->unk_AA8 < 0) && CHECK_FLAG_ALL(gControllerHoldButtons[main_joy[0]], var_s0)) {
            ...
            msgWnd_addStr(&watchGameP->unk_A28, (const char*)watchGameP->password);
...
void draw_virus_number(Gfx** gfxP, u32 arg1, s32 arg2, s32 arg3, f32 arg4, f32 arg5) {
    ...
    for (var_s0 = var_t1 - 1; var_s0 >= 0; var_s0--) {
        StretchAlphaTexBlock(
            gfxP, var_s6, temp_s1, (u8*)temp_s5->texs[1] + (temp_s5->info[0] * temp_s1 * _tbl_4345[sp38[var_s0]] * 2),
            temp_s5->info[0], (u8*)temp_s3->texs[1] + (temp_s3->info[0] * temp_s1 * _tbl_4345[sp38[var_s0]]) / 2,
...
void draw_count_number(Gfx** gfxP, s32 arg1, s32 arg2, u32 arg3, s32 arg4, s32 arg5) {
    ...
    for (i = arg2 - 1; i >= 0; i--) {
        StretchAlphaTexBlock(gfxP, var_s7, temp_s6, (u8*)temp_s5->texs[1] + temp_s5->info[0] * temp_s6 * sp38[i] * 2,
            temp_s5->info[0], (u8*)temp_s2->texs[1] + temp_s2->info[0] * temp_s6 * sp38[i] / 2,
...
void dm_game_init_heap(void) {
    ...
    heapTop = 0; //Heap_bufferp; //todo: fix
...
void dm_game_init(bool arg0) {
    ...
    if (!arg0 || (watchGameP->unk_000 == 0)) {
        ...
        watchGameP->unk_004 = (genrand(0xFFFF) + gc_OSGetTime()) * 0x10001;
        watchGameP->unk_008 = irandom() + gc_OSGetTime();
    }
