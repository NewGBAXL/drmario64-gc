...
void func_800723EC(struct_game_state_data* gameStateDataP, GameMapCell* mapCells, s32 arg2) {
 ...
 */
s32 dm_manual_main_cnt(struct_game_state_data* gameStateData, GameMapCell* mapCells, u8 arg2, s32 arg3) {
...
void dm_manual_all_init(void) {
    ...
    watchManual = (struct struct_watchManual*)ALIGN_PTR(*heap);
    temp_s4 = watchManual;
