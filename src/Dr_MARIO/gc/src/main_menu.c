...
//todo: move const stuff !!
//ASM_DATA;

#include "msg/main_menu.msg"

MainMenuMode _menuMain_lastMode = MAINMENUMODE_MENUMAIN_0;

const char* const _tblMain_5279[] = {
    _mesP1,
    _mes2P,
    _mes4P,
    _mesOpt,
...
const char* const _tblPlay1_5280[] = {
    _mesLv, _mesSt, _mesVsCom, _mesVcFlash, _mesLvTaiQ, _mesLvTimeAt,
};

const char* const _tblPlay2_5281[] = {
    _mesVsMan,
    _mesVmFlash,
    _mesVmTimeAt,
};

const char* const D_8008E7C0[] = {
    _mesVsNum,
    _mesVsNum,
    _mesVsNum,
    _mesVsNum,
...
const char* const _tblBaTyp_5282[] = {
    _mesVs4P,
    _mes4PTag,
    _mes4PFlash,
};

const char* const _tblOpt_5283[] = {
    _mesRec, _mesTutol, _mesName, _mesBak, _mesMisc,
};

const char* const _tblTutol_5284[] = {
    _mesRule1, _mesRule2, _mesRule3, _mesRule4, _mesKotu,
};

const char* const _tblSound_5285[] = {
    _mesStereo,
    _mesMono,
    _mesSound,
    _mesSound,
...
const char* const _tblMisc_5286[] = {
    _mesSnd,
    _mesVsCnt,
    _mesScore,
};

const char* const _loopTbl_5287[] = {
...
//Fix contents later
const char* const _nameEntry_charTable[] = {"ABC"};
...
const s32* const _posX_tbl_9716[] = {
...
bool func_80046C74(MenuItem* item, Gfx** gfxP, TiTexData* arg2, s32 arg3, f32 arg4, f32 arg5, f32 arg6, f32 arg7) {
    ...
    sp28[0] = item->pos[0],
    sp28[1] = item->pos[1],
    sp28[2] = item->unk_30[0],
    sp28[3] = item->unk_30[1],
 ...
 */
s32 menuItem_drawAlphaTex(MenuItem* item, Gfx** gfxP, TiTexData* arg2, TiTexData* arg3, s32 arg4) {
    TexturePtr sp48[2];
    s32 var_s0;
    s32 var_s1;
...
void func_80047074(MenuItem* item, Gfx** gfxP, TiTexData* arg2, s32 arg3, s32 arg4, s32 arg5, f32 arg6, f32 arg7,
    ...
    sp20[0] = item->pos[0];
    sp20[1] = item->pos[1];
    sp20[2] = item->unk_30[0];
    sp20[3] = item->unk_30[1];
...
void menuCursor_draw2(MenuCursor** cursorArr, s32 count, Gfx** gxfP) {
    ...
    for (i = 0; i < count; i++) {
        ...
        if (temp_s0->unk_01C.b.unk_30) {
            ...
            var_s3 += menuItem_drawAlphaTex(&temp_s0->unk_140, &gfx, temp_s1, temp, var_s3);
        }
    }

    for (i = 0; var_s3 = 0, i < 0xB; i++) {
        for (j = 0; j < count; j++) {
            s32 var_v1;
            ...
            var_s3 += func_8004714C(&temp_s0->unk_1D0, &gfx, temp_s1, temp, var_s3, 0xB, i);
        }
    }
...
void func_80048FA0(MenuLvGauge** lvGaugeP, s32 count, Gfx** gxfP) {
    ...
    MenuCursor** sp10 = (MenuCursor**)malloc(sizeof(MenuCursor*) * count);
    s32 i;
...
void menuYN_draw(MenuYN* yn, Gfx** gfxP) {
    ...
    for (i = 0; i < ARRAY_COUNTU(_yn_1767); i++) {
        ...
        {
            fontXX_draw(&gfx, var_fs0, item->pos[1], 12.0f, 12.0f, (const unsigned char*)&_yn_1767[i][j]);
            var_fs0 += 20.0f;
        }
    }
        ...
        for (j = 0, var_s3 = 0; j < _row_1866[i]; j++, var_s3 = 0) {
            ...
            for (k = 0; k < count; k++) {
                ...
                if ((i == menuSpeedAsk->unk_4) && (j == menuSpeedAsk->unk_8)) {
                    ...
                    var_s3 += func_8004714C(&menuSpeedAsk->unk_C, &gfx, temp_s0, a3, var_s3, _row_1866[i], j);
                }
            }
        }
    }
...
void menuNumber_draw(MenuNumber** numberP, s32 arg1, Gfx** gxfP) {
    ...
    for (temp_t4 = 0; temp_t4 < ARRAY_COUNT(_step_2517); temp_t4++) {
        ...
        for (var_fp = 0; var_s6 = 0, var_fp < ARRAY_COUNT(_tbl_2516); var_fp++) {
...
void menuNameSelPanel_draw(MenuNameSelPanel* nameSelPanel, Gfx** gfxP) {
    ...
    MenuCursor** sp2C = (MenuCursor**)malloc(sizeof(MenuCursor*) * nameSelPanel->unk_004);
...
void menuPlay2Panel_init(MenuPlay2Panel* play2Panel, struct_watchMenu* watchMenuRef, void** heapP, s32 arg3, s32 arg4,
    ...
    case 1:
        play2Panel->unk_002C = (void*)ALIGN_PTR(heap);
...
void menuPlay2Panel_draw(MenuPlay2Panel* play2PanelArr[], s32 count, Gfx** gfxP) {
    ...
    void*** arr = (void***)malloc(sizeof(void**) * 8);
    for (j = 0; j < 8; j++) {
        arr[j] = (void**)malloc(sizeof(void*) * count);
    }
...
void menuPlay2PanelSub_init(MenuPlay2PanelSub* play2PanelSub, struct_watchMenu* watchMenuRef, void** heapP,
...
void menuStory_init(MenuStory* menuStory, struct_watchMenu* watchMenuRef, void** heapP) {
    ...
    for (var_s1_3 = CHARANIMEMODE_M; var_s1_3 < ARRAY_COUNTU(menuStory->unk_0038); var_s1_3++) {
        ...
        menuStory->unk_0038[var_s1_3] = (void*)ALIGN_PTR(heap);
        temp_v0_2 = animeState_getDataSize(var_s1_3);
        //heap = menuStory->unk_0038[var_s1_3] + temp_v0_2;
        heap = (u8*)menuStory->unk_0038[var_s1_3] + temp_v0_2;
...
void menuStory_draw(MenuStory* menuStory, Gfx** gfxP) {
    ...
    func_8004714C(&menuStory->unk_00D0, &gfx, temp_v0, temp_s1, 0, 2, menuStory->unk_0028[0]);
...
void menuLvSel_init(MenuLvSel* menuLvSel, struct_watchMenu* watchMenuRef, void** heapP) {
    ...
    case MAINMENUMODE_MENULVSEL_10:
        func_80049894(&menuLvSel->gameLvlIcon, watchMenuRef, 3, temp_s2->unk_08, 0x44, 9);
        menuSpeedItem_init(&menuLvSel->gameLvlSelector, watchMenuRef, 3, 0, temp_s2->unk_08, 0x82, 5, 0x2E);
        break;

    case MAINMENUMODE_MENULVSEL_13:
        func_80049894(&menuLvSel->gameLvlIcon, watchMenuRef, 3, temp_s2->unk_07, 0x44, 9);
        menuSpeedItem_init(&menuLvSel->gameLvlSelector, watchMenuRef, 3, 0, temp_s2->unk_07, 0x82, 5, 0x2E);
        break;

    case MAINMENUMODE_MENULVSEL_7:
        if (temp_s2->unk_04 <= menuLvSel->unk_2570) {
            i = temp_s2->unk_04;
        }
        else {
    ...
    func_80049894(&menuLvSel->speedIcon, watchMenuRef, 1, temp_s2->unk_05, 0x44, 0x28);
    menuSpeedItem_init(&menuLvSel->speedSelector, watchMenuRef, 1, 0, temp_s2->unk_05, 0x82, 0x24, 0x2E);

    func_800466A0(&menuLvSel->speedSelector.unk_014, 1.0f, 0.5f);
    menuMusicItem_init(&menuLvSel->musicSelector, watchMenuRef, temp_s2->unk_06, 0x46, 0x46);
...
void menuPlay2_input(MenuPlay2* menuPlay2) {
    ...
    case MAINMENUMODE_MENUPLAY2_34:
        for (i = 0; i < menuPlay2->unk_00C4; i++) {
            ...
            if (play2Panel->unk_0004 != 0) {
                ...
                temp_a2->unk_14 = play2Panel->unk_12BC.unk_008;
            }
            else {
                temp_a2->unk_15 = play2Panel->unk_0290.unk_00C;
            }
            temp_a2->unk_16 = play2Panel->unk_062C.unk_008;
            temp_a2->unk_18 = menuPlay2->unk_6548.unk_940.unk_0C - 1;
            temp_a2->unk_19 = menuPlay2->unk_6548.unk_0A0.unk_004;
        }
        break;
    ...
    case MAINMENUMODE_MENUPLAY2_21:
        ...
        for (i = 0; i < menuPlay2->unk_00C4; i++) {
            ...
            if (play2Panel->unk_0004 != 0) {
                temp_a2->unk_09[i] = play2Panel->unk_12BC.unk_008;
            }
            else {
                temp_a2->unk_0B[i] = play2Panel->unk_0290.unk_00C;
            }
            temp_a2->unk_0D[i] = play2Panel->unk_062C.unk_008;
        }

        temp_a2->unk_11 = menuPlay2->unk_6548.unk_940.unk_0C - 1;
        temp_a2->unk_12 = menuPlay2->unk_6548.unk_0A0.unk_004;
        break;
    ...
    case MAINMENUMODE_MENUPLAY2_45:
        ...
        evs_cfg_4p.unk_15 = menuPlay2->unk_6548.unk_0A0.unk_004;
        break;
    }
...
void menuPlay2_draw(MenuPlay2* menuPlay2, Gfx** gfxP) {
    ...
    MenuPlay2Panel** arr = (MenuPlay2Panel**)malloc(sizeof(MenuPlay2Panel*) * menuPlay2->unk_00C4);
    s32 i;
    ...
    if ((keyTrg & START_BUTTON) && (menuNmEnt->unk_000C[sp24] != 5)) {
        ...
        case -0x1:
            if (menuNmEnt->unk_0034[sp24] < 4) {
                ...
                menuNmEnt->unk_002C[sp24][menuNmEnt->unk_0034[sp24]] = font2index((const unsigned char*)characterP);
    ...
    for (var_s4 = 0; var_s4 < 9; var_s4++) {
        ...
        for (var_s1 = 0; var_s1 < 0xF; var_s1++) {
            if (*var_s2 & 0x80) {
                ...
                fontXX_draw(&gfx, var_s0, var_s3, 12.0f, 12.0f, (const unsigned char*)var_s2);
            }
            var_s0 += 0xF;
            var_s2 += 2;
        }
...
void menuRankNum_draw(MenuRankNum* rankNumArr[], s32 count, Gfx** gfxP) {
    ...
    for (var_s6 = -1; var_s4 = false, var_s3 = 0, var_s6 < 0xA; var_s6++) {
        s32 var_s7;
        ...
        for (var_s7 = 0; var_s7 < count; var_s7++) {
            ...
            if (var_s6 == -1) {
                ...
                var_s3 += menuItem_drawTex(item, &gfx, temp_s2, var_s3);
            }
            else {
                f32 temp_fs1;
                f32 temp_fs0;
...
void menuRankFig_draw(MenuRankFig** rankFigArr, s32 count, Gfx** gfxP) {
    ...
    for (i = 0; i < 0x13U; i++) {
        ...
        s32 index = font2index((const unsigned char*)&_code_9711[i * 2]);
        s32 j;
...
void menuRankHeader_draw(MenuRankHeader* rankHeaderArr[], s32 count, Gfx** gfxP) {
    ...
    MenuRankLabel** arr = (MenuRankLabel**) malloc(sizeof(MenuRankLabel*) * count * 5);
...
void menuRankPanel_draw(MenuRankPanel** arg0, s32 count, Gfx** gfxP) {
    Gfx* gfx = *gfxP;
    //void* sp10[count * 4];
    void** sp10 = (void**)malloc(sizeof(void*) * count * 4);
...
void menuRank_input(MenuRank* menuRank) {
    ...
    u32 keyRep = _getKeyRep(menuRank->watchMenuRef, 0);
    s32 direction = 0;
    SndIndex sndIndex = SND_INDEX_INVALID;
