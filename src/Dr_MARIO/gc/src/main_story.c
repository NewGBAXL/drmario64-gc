...
#include "main_segment/main_story/curtain_alpha_00_tex.i4"
};

u16 curtain_00_tex[] ALIGNED(8) = {
#include "main_segment/main_story/curtain_00_tex.rgba16"
};

u8 changestar_tex[] ALIGNED(8) = {
#include "main_segment/main_story/changestar_tex.i4"
};*/
...
char STR_800AACF0[] = MSG_COLOR(BLACK) "TEST " MSG_WAIT(2) MSG_END;
...
void* story_bg_init(BgRomDataIndex index, void* dstAddr) {
    ...
    return ALIGN_PTR(ExpandGZip(storyRomData[STORYROMDATA_WAKU2].start, wakuGraphic,
...
void* init_menu_bg(void* dstAddr, bool arg1) {
    ...
    return ALIGN_PTR(ExpandGZip(segmentRomStart, alignedAddress, segmentRomEnd - segmentRomStart));
}
...
void* init_title(void* dstAddr, bool arg1) {
    ...
    title_bmp_data = ALIGN_PTR(
        ExpandGZip(storyRomData[STORYROMDATA_TITLE_ALL].start, title_data,
            storyRomData[STORYROMDATA_TITLE_ALL].end - storyRomData[STORYROMDATA_TITLE_ALL].start));
    return ALIGN_PTR(
        ExpandGZip(storyRomData[STORYROMDATA_TITLE_BMP].start, title_bmp_data,
...
void func_8007A9DC(void) {
    ...
    ptr = ALIGN_PTR(
        ExpandGZip(storyRomData[STORYROMDATA_TITLE_ALL].start, ptr,
            storyRomData[STORYROMDATA_TITLE_ALL].end - storyRomData[STORYROMDATA_TITLE_ALL].start));
    wakuGraphic = ptr;

    ptr = ALIGN_PTR(ExpandGZip(storyRomData[STORYROMDATA_WAKU].start, ptr,
        storyRomData[STORYROMDATA_WAKU].end - storyRomData[STORYROMDATA_WAKU].start));
    bgGraphic = ptr;

    ptr = ALIGN_PTR(
        ExpandGZip(storyRomData[STORYROMDATA_MENU_BG].start, ptr,
